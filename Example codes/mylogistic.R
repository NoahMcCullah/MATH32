...
print(pctacc)
message(sprintf("classification percentage accuracy: %f%%", pctacc))
message(sprintf("%% false pos out of pred neg: %f%%", 100*(confusion[1,2]/sum(confusion[,2]))))
message(sprintf("%% flase pos out of act pos: %f%%", 100*(confusion[1,2]/sum(confusion[1,]))))
