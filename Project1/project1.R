...
posMSE = mean((predict(posCorrModel, newdata = myXTest) - myXTest$ViolentCrimesPerPop)^2)
...
negMSE = mean((predict(negCorrModel, newdata = myXTest) - myXTest$ViolentCrimesPerPop)^2)
...
smartMSE = mean((predict(smartModel, newdata = myXTest) - myXTest$ViolentCrimesPerPop)^2)
